#pragma once
#ifndef COMPUTERGRAFIK_UNTERWASSER_SIMULATION_SCHIFFSLABORHUD_H
#define COMPUTERGRAFIK_UNTERWASSER_SIMULATION_SCHIFFSLABORHUD_H

#include "handwerkHUD.h"

class SchiffslaborHUD : public UIElement {
public:
...
private:
    ...
    bool spielerNaheKonsole() const;
};

#endif //COMPUTERGRAFIK_UNTERWASSER_SIMULATION_SCHIFFSLABORHUD_H
